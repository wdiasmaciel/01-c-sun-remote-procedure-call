...
int
_bin_date_1 (void  *argp, void *result, struct svc_req *rqstp)
{
	return (bin_date_1_svc(result, rqstp));
}

int
_str_date_1 (long  *argp, void *result, struct svc_req *rqstp)
{
	return (str_date_1_svc(*argp, result, rqstp));
}
...
date_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case bin_date:
		...
		local = (bool_t (*) (char *, void *,  struct svc_req *))_bin_date_1;
		break;

	case str_date:
		_xdr_argument = (xdrproc_t) xdr_long;
		_xdr_result = (xdrproc_t) xdr_wrapstring;
		local = (bool_t (*) (char *, void *,  struct svc_req *))_str_date_1;
		break;
